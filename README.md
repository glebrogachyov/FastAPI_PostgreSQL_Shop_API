...
Для полноценного тестирования API можно открыть в браузере страницу с OpenAPI документацией: http://localhost:8000/, наполнить таблицу данными, отправив POST-запрос init_tables, и оценить работу реализованных методов.
После всех тестов следует вызвать метод drop_tables для удаления созданных таблиц, эти методы писались для удобства разработки, но я решил их оставить и для более простого тестирования.
